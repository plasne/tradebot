...
module.exports = class Gemini {
    ...
    async buy(method, code, volume, price) {
        const self = this;
        try {
            ...
            // record the activity to the database
            const connection = await self.record({
                exchange: "Gemini",
                guid: "new-guid",
                code: code,
                type: "buy",
